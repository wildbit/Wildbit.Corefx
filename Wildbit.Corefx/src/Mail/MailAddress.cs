...
namespace Wildbit.Corefx.Mail
{
    ...
    public partial class MailAddress
    {
        ...
        private string GetUser(bool allowUnicode)
        {
            ...
            {
                throw new SmtpException(string.Format(Strings.SmtpNonAsciiUserNotSupported, Address));
            }
            return _userName;
        }
        ...
        private string GetHost(bool allowUnicode)
        {
            ...
            if (!allowUnicode && !MimeBasePart.IsAscii(domain, true))
            {
                ...
                {
                    throw new SmtpException(string.Format(Strings.SmtpInvalidHostName, Address), argEx);
                }
            }
            return domain;
        }
