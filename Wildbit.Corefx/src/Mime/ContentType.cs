...
namespace Wildbit.Corefx.Mime
{
    ...
    public class ContentType
    {
        ...
        public ContentType(string contentType)
        {
            ...
            {
                throw new ArgumentException(string.Format(Strings.net_emptystringcall, nameof(contentType)), nameof(contentType));
            }
        ...
        public string MediaType
        {
            ...
            set
            {
                ...
                if (_mediaType.Length == 0 || offset >= value.Length || value[offset++] != '/')
                    throw new FormatException(Strings.MediaTypeInvalid);
