    ...
    internal class MimePart : MimeBasePart, IDisposable
    {
        ...
        internal TransferEncoding TransferEncoding
        {
            ...
            set
            {
                ...
                {
                    throw new NotSupportedException(string.Format(Strings.MimeTransferEncodingNotSupported, value));
                }
            }
        }
        ...
        internal void ResetStream()
        {
            if (_streamUsedOnce)
            {
                ...
                {
                    throw new InvalidOperationException(Strings.MimePartCantResetStream);
                }
            }
        }
    }
