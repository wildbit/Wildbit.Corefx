...
namespace Postmark.Corefx.Mail
{
    public abstract class AttachmentBase : IDisposable
    {
        ...
        internal void SetContentFromFile(string fileName, ContentType contentType)
        {
            ...
            {
                throw new ArgumentException(string.Format(Strings.net_emptystringcall, nameof(fileName)), nameof(fileName));
            }
        ...
        public string ContentId
        {
            ...
            set
            {
                ...
                else
                {
                    ...
                    {
                        throw new ArgumentException(Strings.MailHeaderInvalidCID, nameof(value));
                    }
